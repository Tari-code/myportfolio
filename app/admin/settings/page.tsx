...
import { Save, Bell, Shield, User, Loader2, CheckCircle, Edit3, X, Eye, EyeOff, Camera, Phone } from "lucide-react";
      ...
      <div className="container mx-auto max-w-4xl">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 md:gap-6 mb-8 md:mb-12">
          <div className="max-w-[280px] md:max-w-none">
            <h1 className="text-3xl md:text-4xl font-display font-bold text-foreground mb-1 tracking-tight">Admin Settings</h1>
            <p className="text-foreground/60 text-sm md:text-base font-medium tracking-wide">Manage your administrator profile and security.</p>
          </div>
          {status && (
            ...
            <div className={`glass-panel p-6 md:p-10 rounded-[1.5rem] md:rounded-[2.5rem] border transition-all duration-300 min-h-[200px] ${editSecurity ? 'border-purple-500/50 ring-4 ring-purple-500/5' : 'border-card-border'}`}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                <div className="space-y-2 md:space-y-3">
                  ...
                  <div className="relative group">
                    <Shield className="absolute left-4 top-1/2 -translate-y-1/2 text-foreground/20 group-focus-within:text-brand-500 transition-colors" size={18} />
                    <input
